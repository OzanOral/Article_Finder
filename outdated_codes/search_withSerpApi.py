...
from config import API_KEY, all_titles_reviewed as query_year
from datetime import datetime


# Queries
titles = ["KRAS Mutation Is Present in a Small Subset of Primary Urinary Bladder Adenocarcinomas"
]
...
for title in titles:
    ...
    if "Alexander" in summary:
        with open('NewVersion/Results_SerpApi.txt', 'a') as f:
            f.write(f_result)
